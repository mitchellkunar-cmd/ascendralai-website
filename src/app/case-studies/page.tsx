...
export const metadata: Metadata = {
  title: "Case Studies — AscendralAI",
...
const caseStudies = [
  {
    ...
    author: "Owner, Buckeye HVAC Services",
  },
  {
    ...
    author: "Property Manager, Premier Property Management",
  },
  {
    company: "Wright Commercial Contractors",
    ...
    author: "Operations Manager, Wright Commercial Contractors",
  },
];
      ...
      <section className="py-16 bg-dark-900">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          {caseStudies.map((cs, idx) => (
            <article key={cs.company} className="bg-dark-700 rounded-2xl border border-white/5 overflow-hidden">
              {/* Header */}
              <div className="px-8 py-6 border-b border-white/5 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">{cs.industry}</p>
                </div>
              </div>
              ...
              <div className="p-8 space-y-8">
                ...
                <blockquote className="border-l-2 border-primary-500 pl-6 py-2">
                  <p className="text-gray-300 italic">&ldquo;{cs.quote}&rdquo;</p>
                  <cite className="text-gray-500 text-sm mt-2 block not-italic">— {cs.author}</cite>
                </blockquote>
              </div>
            </article>
          ))}
